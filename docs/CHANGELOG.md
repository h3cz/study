...
- Added dashboard discovery for the Study Lab and changelog.
- Added QR sharing for `https://study.hecz.dev/lab`.
- Added a class-share section with the live lab hub, public starter repo, class pack, and decks.
- Added a five-question demo-bank walkthrough.
- Tightened mobile layout so long labels and cards do not create sideways scrolling.
